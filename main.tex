...
One of the more common CC excitation is CCSD(T) (the single, double, and pertubative triple excitation) as is often seen as the ``gold standard'' in that it offers a good balance between accuracy and cost.
...
\begin{scriptsize}
\begin{centering}
\begin{tabular}{m{0.5in}||m{0.25in} | m{0.5in} | m{0.8in} | m{0.75in}| m{0.5in}| m{0.5in }|m{0.5in}| m{0.5in}| m{0.5in}| m{0.5in}| m{0.5in}| m{0.5in} | m{0.5in}}
